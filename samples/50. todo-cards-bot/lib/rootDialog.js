...
const deleteSelectedToDos_1 = require("./deleteSelectedToDos");
class RootDialog extends botbuilder_dialogs_adaptive_1.AdaptiveDialog {
    constructor() {
        ...
        this.addRule(new botbuilder_dialogs_adaptive_1.IntentRule('#DeleteSelectedToDos', [
            new deleteSelectedToDos_1.DeleteSeletedToDos()
        ]));

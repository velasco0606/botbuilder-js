...
class AddToDo extends botbuilder_dialogs_adaptive_1.AdaptiveDialog {
    constructor() {
        super('AddToDo', [
            new botbuilder_dialogs_adaptive_1.TextInput('dialog.title', '@title', `What would you like to call your new todo?`),
            new botbuilder_dialogs_adaptive_1.EditArray(botbuilder_dialogs_adaptive_1.ArrayChangeType.push, 'user.todos', 'dialog.title'),
            new botbuilder_dialogs_adaptive_1.DebugBreak(),
            new botbuilder_dialogs_adaptive_1.SendActivity(`Added a todo named "{dialog.title}". You can delete it by saying "delete todo named {$title}".`),

...
async function LoadDialog(path, resourcesFolder) {
    readPackageJson(path, async function (err, json) {
        ...
        dialogManager = new botbuilder_dialogs_1.DialogManager();
        dialogManager.conversationState = new botbuilder_1.ConversationState(new botbuilder_1.MemoryStorage());
        dialogManager.userState = new botbuilder_1.UserState(new botbuilder_1.MemoryStorage());
        // bind rootDialog
